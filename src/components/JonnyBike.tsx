...
function JonnyBike() {
  ...
  return (
    <div>
      <div className="pb-10">
        <div className="component-width relative mb-4 mt-6 w-4/5 justify-center rounded-xl border-2 border-gray-500 bg-blue-100 px-16 pb-4 pt-4 text-3xl">
        ...
        <Image
          ...
          src="/jonnys-bike-spa/image0.jpg"
          alt="GT Grade 2018"
          width={700}
          height={475}
        />
